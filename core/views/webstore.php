<div class="container rodape-overlay">
    <!-- Secções -->
    <div class="row">
        <div class="col-sm-6 offset-sm-3 text-center my-4">

            <a href="?a=webstore&c=geral" class="btn btn-secondary mx-1 btn-sm">Geral</a>
            <?php foreach ($categorias as $categoria) : ?>
                <a href="?a=webstore&c=<?= $categoria ?>" class="btn btn-primary mx-1 btn-sm">
                    ...
                    <div class="text-center p-3 box-product">
                        ...
                        <div class="text-center my-2">
                            ...
                            <?php if($produto->stock > 0): ?>
                                <!-- Existe em stock -->
                                <button class="btn btn-primary btn-sm" onclick="addToShoppingCart(<?= $produto->id_produto ?>)">
