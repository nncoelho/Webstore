        ...
        <div class="col-md-10">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    ?>
                    <div class="row">
                        <label for="inputPassword" class="col-sm-4 text-end col-form-label">Escolher estado:<i class="far fa-hand-point-right fa-lg ms-2"></i></label>
                        <div class="col-sm-8">
                        ...
                        <tbody>
                            <?php foreach ($listing_orders as $order) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="?a=order_details&e=<?= Store::aesEncrypt($order->id_encomenda) ?>"><?= $order->status ?></a>
                                    </td>
